...
- Safe flight limits never stop forward motion. Cloud Rest remains a brief consequence after nearby Playful Bumps and resumes automatically with all progress preserved. _(Superseded by [ADR-0013](./0013-keep-one-game-mode-and-answer-low-flight-with-a-floor.md): Cloud Rest and Gentle Help leave the MVP.)_
