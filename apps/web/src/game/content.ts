...
export const STOP_STORIES: readonly StopStory[] = [
  ...
  },
  {
    ...
    guest: "Dad",
    moment: "Dad kept the Castle Star shining safe at the Birthday Castle gates!",
    icon: "🏰",
    sky: 0xf6b6cf,
    ground: 0xe6ae55,
...
export const OPENING_STORYBOOK_MOMENTS_AFTER_COVER = [
  ...
  {
    eyebrow: "Then—WHOOSH!",
    title: "Six Stars flew away",
    copy: "A playful wind scattered six Birthday Stars across Fairytale Sicily. Dad kept the seventh, the Castle Star, safe at the Birthday Castle!",
