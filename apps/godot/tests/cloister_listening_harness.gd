...
const LISTENING_PASS := [
	...
	["listen for Cloud Rest and its automatic resume", 5.0,
		[[&"sound-event.cloud-rest-entered", {"place": "cloister"}],
		[&"sound-event.cloud-rest-exited", {"place": "cloister"}]]],
